...
class Nomina extends Migration
{
    ...
    public function up()
    {
        Schema::create('nomina', function (Blueprint $table) {
            ...
            $table->integer('horased')->nullable();
            $table->integer('horasen')->nullable();
            $table->integer('bonificaciones')->nullable();
            $table->integer('comisiones')->nullable();
            $table->integer('auxtransportes')->nullable();
            $table->integer('auxalimentos')->nullable();
            $table->integer('aporteeps')->nullable();
            $table->integer('aportepension')->nullable();
            $table->integer('aportefondoempleados')->nullable();
            $table->integer('libranza')->nullable();
            $table->integer('embargos')->nullable();
            $table->integer('retencionfuente')->nullable();
