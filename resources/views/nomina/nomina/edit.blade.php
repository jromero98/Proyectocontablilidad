...
<style type="text/css">
	...
	.table td{
	    ...
	    {!!Form::model($empleado,['method'=>'PATCH','route'=>['nomina.update',$empleado->idNomina]])!!}
	    {{Form::token()}}

		<div class="row"> 
			<div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
				<label form="empleado">Empleado</label>
				<input type="text" class="hidden" value="{{$empleado->ced_empleado}}">
				<label class="form-control">{{$empleado->ced_empleado}} {{$empleado->nombre_empleado}}</label>
			</div>
			<br>
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				<div class="form-group">
					<label for="diast">Dias trabajados</label>
					<input type="number" class="form-control" name="diast" id="diast" value="{{$empleado->Diastrabajados}}" placeholder="Dias trabajados">
				</div>
			</div>
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				<div class="form-group">
					<label for="salario">Salario</label>
					<input type="text" class="form-control" name="salario" id="salario" readonly="" value="{{number_format($empleado->Diastrabajados*($empleado->Salario/30))}}" placeholder="Salario">
				</div>
			</div>			
		</div>
		...
		<div class="row">
			<div class="panel panel-primary">
				<div class="panel-body">
					<div class="col-md-3">
						@if($empleado->HorasED!="")
							<input type="checkbox" name="hed"  id="hed" checked="true"> Horas Extras Diurnas
						@else
					...
					<div class="col-md-3">
						@if($empleado->HorasEN!="")
							<input type="checkbox" name="hen" id="hen" checked="true"> Horas Extras Nocturnas
						@else
							<input type="checkbox" name="hen" id="hen"> Horas Extras Nocturnas
						@endif
					</div>
					<div class="col-md-3">
						@if($empleado->Auxtransportes!="")
							<input type="checkbox" name="axt" id="axt" checked="true"> Auxilio de Transporte
						@else
							<input type="checkbox" name="axt" id="axt"> Auxilio de Transporte
						@endif
					</div>
					<div class="col-md-3">
						@if($empleado->Auxalimentos!="")
							<input type="checkbox" name="axc" id="axc" checked="true"> Auxilio de Alimentos
						@else
							<input type="checkbox" name="axc" id="axc"> Auxilio de Alimentos
						@endif
					</div>
					<div class="col-md-6 text-center">
						@if($empleado->Bonificaciones!=0)
							<input type="checkbox" name="boni" id="boni" checked="true"> Bonificaciones
						@else
							<input type="checkbox" name="boni" id="boni"> Bonificaciones
						@endif
					</div>
					<div class="col-md-6 text-center">
						@if($empleado->Comisiones!=0)
							<input type="checkbox" name="comi" id="comi" checked="true"> Comisiones
						@else
					...
					<table id="Devengados" border="" class="table table-striped table-bordered">
						...
						<tr id="dhed">
							...
							<td><input type="number" class="form-control" name="horased" value="{{$empleado->HorasED}}" id="horased" placeholder="Horas extas Diurnas"></td>
						...
						<tr id="dhen">
							...
							<td><input type="number" class="form-control" name="horasen" value="{{$empleado->HorasEN}}" id="horasen" placeholder="Horas extas Nocturnas"></td>
						...
						<tr id="daxt">
							...
							<td COLSPAN=2><input type="text" class="form-control" value="{{$empleado->Auxtransportes}}" name="auxtrans" id="auxtrans" readonly="" placeholder="Auxilio de transporte"></td>
						</tr>
						<tr id="daxc">
							<th class="col-md-2">Auxilio Comida</th>
							<td COLSPAN=2><input type="text" class="form-control" name="auxcom" value="{{$empleado->Auxalimentos}}" id="auxcom" readonly="" placeholder="Auxilio de comida"></td>
						</tr>
						<tr id="bonis">
							<th class="col-md-2">Bonificaciones</th>
							<td COLSPAN=2><input type="text" class="form-control" name="bonificacion" id="bonificacion" placeholder="Bonificaciones" value="{{$empleado->Bonificaciones}}"></td>
						</tr>
						<tr id="comis">
							<th class="col-md-2">Comisiones</th>
							<td COLSPAN=2><input type="text" class="form-control" name="comision" id="comision" value="{{$empleado->Comisiones}}" placeholder="Comisiones"></td>
						</tr>
						<tr>
				...
				<div class="panel-body">
					<table id="Deducibles" border="" class="table table-striped table-bordered">
						...
						<tr>
							...
							<td colspan="2"><input type="text" class="form-control" name="aeps" value="{{$empleado->AporteEps}}" id="aeps" readonly="" placeholder="Valor"></td>
						</tr>
						<tr>
							<th class="col-md-2">Aporte Fondo de Pension</th>
							<td colspan="2"><input type="text" class="form-control" name="afp" id="afp" value="{{$empleado->Aportepension}}" readonly="" placeholder="Valor"></td>
						</tr>
						<tr>
							<th class="col-md-2">Aporte Fondo de Empleados</th>
							@if($empleado->Auxalimentos!="")
								<td class="col-md-3"><input type="checkbox" id="chafe" checked="true"></td>
							@else
								<td class="col-md-3"><input type="checkbox" id="chafe"></td>
							@endif
							<td><input type="text" class="form-control" name="afe" id="afe" readonly="" value="{{$empleado->Aportefondoempleados}}" placeholder="Aporte Fondo de empleados"></td>
						</tr>
						<tr>
							<th class="col-md-2">Libranza</th>
							<td COLSPAN=2><input type="text" class="form-control" name="libranza" value="{{$empleado->libranza}}" id="libranza" placeholder="Libranza"></td>
						</tr>
						<tr id="daxc">
							<th class="col-md-2" title="Denuncias y demás">Embargos</th>
							<td COLSPAN=2><input type="text" class="form-control" name="embargos" id="embargos" value="{{$empleado->embargos}}" placeholder="Embargos"></td>
						</tr>
						<tr id="daxc">
							<th class="col-md-2">Retencion de la Fuente</th>
							<td COLSPAN=2><input type="text" class="form-control" name="retencionfuente" id="retencionfuente" value="{{$empleado->retencionfuente}}" readonly="" placeholder="Retencion de la Fuente"></td>
						</tr>
						<tr>
		...
		<input type="text" id="sueldo" name="sueldo" value="{{$empleado->Salario}}" class="hidden">
...
<script>
	...
	setInterval( function() { 
		...
		if($("#empleado option:selected").val()!=""){
			...
			if ($("#diast").val()!=""&&(($("#sueldo").val()/30)*$("#diast").val())/{{$calculo->UVT}}>95) {
