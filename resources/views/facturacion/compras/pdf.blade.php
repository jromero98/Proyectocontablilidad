<html>
    <head>
        ...
        <title>Factura de compra # {{$factura->Num_factura}}</title>
    </head>
    <body>
    ...
    <?php 
                    ...
                    ?>
        <h1>
            Factura de compra # {{$factura->Num_factura}}
            <small>
    ...
    <table class="client-detail">
        ...
        @else
            <tr>
            <th style="width:100px;">
                Proveedor:  {{$persona->nombre_persona}}
            </th>
            <td></td>
        </tr>
        <tr>
    ...
    <table class="items">
        ...
        @foreach($detalles as $detalle)
            <tr>
                ...
                <td class="text-right">$ {{number_format($detalle->precio_compra)}}</td>
                <td class="text-right">$ {{number_format($detalle->cantidad*$detalle->precio_compra)}}</td>
            </tr>
        @endforeach
        </tbody>
        <tfoot>
