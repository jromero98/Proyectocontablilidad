	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<div class="form-group">
				...
				<input type="text" readonly value="{{$factura->Num_factura}}" name="comprobante" class="form-control" placeholder="Numero de Comprobante...">
			</div>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<div class="form-group">
					...
					<tbody>
						@foreach($detalles as $detalle)
						    <tr class="selected" id="fila'+cont+'">
                                ...
                                <td><input type="hidden" name="idarticulo[]" value="{{$detalle->idArticulo}}">
                                    @foreach($articulo as $art)
                                        @if($art->idArticulos==$detalle->idArticulo)
                                            {{$art->idArticulos}} {{$art->nom_articulo}}
					                   @endif
					                @endforeach
                                </td>
                                <td><input type="number" name="cantidad[]" value="{{$detalle->cantidad}}" readonly></td>
                                <td><input type="text" name="precio_compra[]" value="{{number_format($detalle->precio_compra)}}" readonly></td>
                                <td><input type="text" name="precio_venta[]" value="{{number_format($detalle->precio_venta)}}"></td>
