					...
					<tbody>
						@foreach($detalles as $detalle)
						    <tr class="selected" id="fila'+cont+'">
                                ...
                                <td><input type="text" name="precio_venta[]" value="{{number_format($detalle->precio_venta)}}" readonly></td>
                                <td><input type="text" name="descuento[]" value="{{number_format($detalle->descuento)}}"></td>
